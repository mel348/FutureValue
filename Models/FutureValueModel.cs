...
namespace FutureValue.Models
{
    public class FutureValueModel
    {
        ...
        [Range(1, 50, ErrorMessage = "Numbers of years must be between 1 and 50.")]
        ...
        public decimal? CalculateFutureValue()
        {
            ...
            {
                futureValue = (futureValue + MonthlyInvestment) * (1 + monthlyInterestRate);    //calculate and return future value
            }
            return futureValue;
        }
    }
